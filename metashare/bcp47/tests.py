...
class Bcp47Tests(TestCase):
    ...
    def test_update_lang_variants(self):
        ...
        response = self.client.post('/{0}update_lang_variants/'.format(DJANGO_BASE),
                                    post_data)
    ...
    def test_update_var_variants(self):
        ...
        response = self.client.post('/{0}update_var_variants/'.format(DJANGO_BASE),
                                    post_data)
        self.assertEquals(response.content, result)
    ...
    def test_update_lang_variants_with_script(self):
        ...
        response = self.client.post('/{0}update_lang_variants_with_script/'.format(DJANGO_BASE),
                                    post_data)
        self.assertEquals(response.content, result)
